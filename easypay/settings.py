...
ALLOWED_HOSTS = ['easybilz-api.onrender.com', '127.0.0.1', 'localhost','http://localhost:5173']
...
DATABASES = {
    'default': {
        ...
        'HOST': 'viaduct.proxy.rlwy.net',  # Set to 'localhost' or the IP address of your database server
        'PORT': '32231',  # Default PostgreSQL port is '5432'
    }
}
